...
<p align="center">
  ...
  ·
  <a href="https://github.com/wookzzz57-beep/first-window/pull/62">Advanced handoff (in review)</a>
  ·
...
> **Release status:** The downloadable **v0.4.3 EXE does not include the advanced handoff button**. The implementation is being reviewed in [PR #62](https://github.com/wookzzz57-beep/first-window/pull/62); configuration tests are not proof that real image/video API calls succeed on every account.
...
Direct Agnes CLI is not required for the beginner path. Native Hermes is a separate advanced option: [track the dedicated Agnes + Hermes handoff in PR #62](https://github.com/wookzzz57-beep/first-window/pull/62). This unreleased opt-in feature creates an independent profile rather than modifying the beginner profile.
